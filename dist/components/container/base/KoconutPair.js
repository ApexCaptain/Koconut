...
var _KoconutBoolean = require("./KoconutBoolean");
  ...
  (0, _createClass2["default"])(Pair, [{
    ...
    value: function equalsTo(other) {
      ...
      if (_module.KoconutTypeChecker.checkIsEquatable(this.firstElement) && _module.KoconutTypeChecker.checkIsEquatable(other.firstElement)) {
        ...
        if (firstCompareResult instanceof _module.KoconutPrimitive) {
          var koconutToReturn = new _KoconutBoolean.KoconutBoolean();
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 3:
                    ...
                    if (!(compareResult instanceof _module.KoconutPrimitive)) {
                      _context.next = 11;
                      break;
                    }
          ...
          if (_module.KoconutTypeChecker.checkIsEquatable(this.secondElement) && _module.KoconutTypeChecker.checkIsEquatable(other.secondElement)) {
            ...
            if (secondCompareResult instanceof _module.KoconutPrimitive) return _KoconutBoolean.KoconutBoolean['fromPrimitive'](secondCompareResult);else return secondCompareResult;
        ...
        if (_module.KoconutTypeChecker.checkIsEquatable(this.secondElement) && _module.KoconutTypeChecker.checkIsEquatable(other.secondElement)) {
          ...
          if (compareResult instanceof _module.KoconutPrimitive) return _KoconutBoolean.KoconutBoolean['fromPrimitive'](compareResult);else return compareResult;
        } else return this.secondElement == other.secondElement;
      }
    }
  }], [{

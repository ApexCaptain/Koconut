...
var KoconutIterable = function (_KoconutPrimitive) {
  ...
  function KoconutIterable() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "combinedDataWrapper", void 0);
  ...
  (0, _createClass2["default"])(KoconutIterable, [{
    ...
    key: "maxOfWith",
    value:
    function maxOfWith(selector, comparator) {
      var _this7 = this;
    ...
    key: "maxOfWithOrNull",
    value:
    function maxOfWithOrNull(selector, comparator) {
      var _this8 = this;
      var selectorThisArg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var comparatorThisArg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      selector = selector.bind(selectorThisArg);
    ...
    key: "maxWithOrNull",
    value:
    function maxWithOrNull(comparator) {
      var _this10 = this;
      var thisArg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      comparator = comparator.bind(thisArg);
      var koconutToReturn = new _module.KoconutPrimitive();
    ...
    key: "minOfWith",
    value:
    function minOfWith(selector, comparator) {
      var _this15 = this;
      var selectorThisArg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var comparatorThisArg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      selector = selector.bind(selectorThisArg);
    ...
    key: "minOfWithOrNull",
    value:
    function minOfWithOrNull(selector, comparator) {
      var _this16 = this;
      var selectorThisArg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var comparatorThisArg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      selector = selector.bind(selectorThisArg);
    ...
    key: "minWithOrNull",
    value:
    function minWithOrNull(comparator) {
      var _this18 = this;
      var thisArg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      comparator = comparator.bind(thisArg);
      var koconutToReturn = new _module.KoconutPrimitive();

  ...
  (0, _createClass2["default"])(KoconutSet, [{
    ...
    value: function () {
      var _validate = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(data) {
        var _index, keys, _iterator, _step, eachDatum, _this$data, isConflict, _iterator2, _step2, eachPrevEquatablekDatum, equalityResult;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                ...
                equalityResult = eachDatum.equalsTo(eachPrevEquatablekDatum);

...
export declare class KoconutSet<DataType> extends KoconutCollection<DataType, Set<DataType>> {
     ...
     * ```
     */
    static generate<DataType>(count: number, generator: (index: number) => DataType | Promise<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    onEach(action: (element: DataType) => boolean | KoconutLoopSignal | void | Promise<boolean | KoconutLoopSignal | void>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    onEachIndexed(action: (index: number, element: DataType) => boolean | KoconutLoopSignal | void | Promise<boolean | KoconutLoopSignal | void>, thisArg?: any): KoconutSet<DataType>;
    /**
    ...
    associateTo<KeyType, ValueType>(destination: Map<KeyType, ValueType>, transform: (element: DataType) => [
        ...
        KeyType,
        ValueType
    ] | Pair<KeyType, ValueType> | KoconutPair<KeyType, ValueType> | Entry<KeyType, ValueType> | KoconutEntry<KeyType, ValueType>>, thisArg?: any): KoconutSet<DataType>;
    /**

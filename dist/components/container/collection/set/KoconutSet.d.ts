import { Pair, KoconutPair, Entry, KoconutEntry, KoconutCollection, KoconutEquatable, KoconutComparable, Generator, Action, IndexedAction, Transformer, IndexedTransformer, Selector, Predicator, IndexedPredicator, Comparator } from '../../../../module';
export declare class KoconutSet<DataType> extends KoconutCollection<DataType, Set<DataType>> {
     ...
     * ```
     */
    constructor(set?: Iterable<DataType> | null);
    /**
     ...
     * ```
     */
    retrieve(): Promise<KoconutSet<DataType>>;
     ...
     * ```
     */
    static from<DataType>(source?: Iterable<DataType> | null): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    static generate<DataType>(count: number, generator: Generator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    onEach(action: Action<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    onEachIndexed(action: IndexedAction<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    associateByTo<KeyType, ValueType = DataType>(destination: Map<KeyType, ValueType>, keySelector: Selector<DataType, KeyType>, valueTransform?: Transformer<DataType, ValueType> | null, keySelectorThisArg?: any, valueTransformThisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    flatMapTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: Transformer<DataType, Iterable<ResultDataType>>, thisArg?: any): KoconutSet<DataType>;
    /**
     * Appends all elements yielded from results of ```transform``` function being invoked
     ...
     * ```
     */
    flatMapIndexedTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: IndexedTransformer<DataType, Iterable<ResultDataType>>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    groupByTo<KeyType, ValueType = DataType>(destination: Map<KeyType, Array<ValueType>>, keySelector: Selector<DataType, KeyType>, valueTransform?: Transformer<DataType, ValueType> | null, keySelectorThisArg?: any, valueTransformThisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    mapTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: Transformer<DataType, ResultDataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     * Applies the given ```transform``` function to each element of the original collection
     ...
     * ```
     */
    mapNotNullTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: Transformer<DataType, ResultDataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    mapIndexedTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: IndexedTransformer<DataType, ResultDataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     * Applies the given ```transform``` function to each element and its index in the original
     ...
     * ```
     */
    mapIndexedNotNullTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: IndexedTransformer<DataType, ResultDataType | void | null | undefined>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    distinctBy<KeyType, EquatableKeyType extends KoconutEquatable>(selector: Selector<DataType, KeyType | EquatableKeyType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    dropLastWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    dropWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    filter(predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    filterNot(predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    filterTo(destination: Array<DataType> | Set<DataType>, predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    filterNotTo(destination: Array<DataType> | Set<DataType>, predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    filterIndexed(predicate: IndexedPredicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    filterIndexedTo(destination: Array<DataType> | Set<DataType>, predicate: IndexedPredicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    sortedBy(selector: Selector<DataType, number | string | KoconutComparable>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    sortedByDescending(selector: Selector<DataType, number | string | KoconutComparable>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    sortedWith(comparator: Comparator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    takeLastWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;
    /**
     ...
     * ```
     */
    takeWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutSet<DataType>;

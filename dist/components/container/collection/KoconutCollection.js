  ...
  (0, _createClass2["default"])(KoconutCollection, [{
    ...
    value: function containsAll(elements) {
      ...
      koconutToReturn.setPrevYieldable(this).setProcessor((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee7() {
        ...
        }, _callee7, null, [[4, 47, 50, 53], [11, 31, 34, 37]]);
      })));
      return koconutToReturn;
    }
  }, {
    ...
    value: function distinct() {
      ...
      koconutToReturn.setPrevYieldable(this).setProcessor((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee10() {
        ...
        }, _callee10, null, [[3, 45, 48, 51], [10, 30, 33, 36]]);
      })));
      return koconutToReturn;
    }
  }, {
    ...
    value: function distinctBy(selector) {
      ...
      koconutToReturn.setPrevYieldable(this).setProcessor((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee11() {
        ...
        }, _callee11, null, [[5, 49, 52, 55], [15, 35, 38, 41]]);
      })));
      return koconutToReturn;
    }
  }, {
        ...
        return _regenerator["default"].wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                processedArray = new Array();
                if (_this13.data != null) processedArray = Array.from(_this13.data).slice(n);
        ...
        return _regenerator["default"].wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                processedArray = new Array();
                if (_this14.data != null) processedArray = Array.from(_this14.data).slice(0, -n);
        ...
        return _regenerator["default"].wrap(function _callee25$(_context25) {
          while (1) {
            switch (_context25.prev = _context25.next) {
              case 0:
                processedArray = _this26.data ? Array.from(_this26.data).slice(0, n) : new Array();
        ...
        return _regenerator["default"].wrap(function _callee26$(_context26) {
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
                processedArray = _this27.data ? Array.from(_this27.data).slice(_this27.mSize - n, _this27.mSize) : new Array();
    ...
    value: function indexOf(elementToFind) {
      ...
      koconutToReturn.setPrevYieldable(this).setProcessor((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee36() {
        var _iterator18, _step18, _step18$value, _index, _element, equalityResult;
          ...
          while (1) {
            switch (_context36.prev = _context36.next) {
              ...
              case 4:
                ...
                _step18$value = (0, _slicedToArray2["default"])(_step18.value, 2), _index = _step18$value[0], _element = _step18$value[1];

                if (!_module.KoconutTypeChecker.checkIsEquatable(_element)) {
                  _context36.next = 20;
                  break;
                }

                equalityResult = _element.equalsTo(elementToFind);
              ...
              case 16:
                ...
                return _context36.abrupt("return", _index);
    ...
    value: function indexOfFirst(predicate) {
      ...
      koconutToReturn.setPrevYieldable(this).setProcessor((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee37() {
        var _iterator19, _step19, _step19$value, _index2, _element2;
          ...
          while (1) {
            switch (_context37.prev = _context37.next) {
              ...
              case 4:
                ...
                _step19$value = (0, _slicedToArray2["default"])(_step19.value, 2), _index2 = _step19$value[0], _element2 = _step19$value[1];
                _context37.next = 8;
              ...
              case 8:
                ...
                return _context37.abrupt("return", _index2);
          ...
          while (1) {
            switch (_context58.prev = _context58.next) {
              ...
              case 10:
                ...
                return _context58.abrupt("return", dataArray[eachIndex] != undefined ? dataArray[eachIndex] : null);
              ...
              case 17:
                return _context58.abrupt("return", dataArray[length - 1] != undefined ? dataArray[length - 1] : null);
        ...
        return _regenerator["default"].wrap(function _callee61$(_context61) {
          while (1) {
            switch (_context61.prev = _context61.next) {
              case 0:
                processedArray = _this62.data ? Array.from(_this62.data) : new Array();
        ...
        return _regenerator["default"].wrap(function _callee68$(_context68) {
          while (1) {
            switch (_context68.prev = _context68.next) {
              case 0:
                processedArray = _this69.data ? Array.from(_this69.data).reverse() : new Array();
        ...
        return _regenerator["default"].wrap(function _callee80$(_context80) {
          while (1) {
            switch (_context80.prev = _context80.next) {
              case 0:
                processedSet = _this81.data == null ? new Set() : new Set(_this81.data);
    ...
    value: function withIndex() {
      ...
      koconutToReturn.setPrevYieldable(this).setProcessor((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee82() {
        var processedArray, _iterator43, _step43, _step43$value, _index3, _element3;
                ...
                if (_this83.data != null) {
                  ...
                  try {
                    for (_iterator43.s(); !(_step43 = _iterator43.n()).done;) {
                      _step43$value = (0, _slicedToArray2["default"])(_step43.value, 2), _index3 = _step43$value[0], _element3 = _step43$value[1];

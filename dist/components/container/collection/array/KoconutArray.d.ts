import { Pair, KoconutPair, Entry, KoconutEntry, KoconutCollection, KoconutEquatable, KoconutComparable, Predicator, IndexedPredicator, Action, IndexedAction, Generator, Selector, Transformer, IndexedTransformer, Comparator } from '../../../../module';
export declare class KoconutArray<DataType> extends KoconutCollection<DataType, Array<DataType>> {
     ...
     * ```
     */
    constructor(array?: Iterable<DataType> | null);
    /**
     ...
     * ```
     */
    retrieve(): Promise<KoconutArray<DataType>>;
    /**
     * Creates a new instance from ```iterable``` object.
     *
     ...
     * ```
     */
    static from<DataType>(source?: Iterable<DataType> | null): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    static generate<DataType>(count: number, generator: Generator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    onEach(action: Action<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    onEachIndexed(action: IndexedAction<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    associateByTo<KeyType, ValueType = DataType>(destination: Map<KeyType, ValueType>, keySelector: Selector<DataType, KeyType>, valueTransform?: Transformer<DataType, ValueType> | null, keySelectorThisArg?: any, valueTransformThisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    flatMapTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: Transformer<DataType, Iterable<ResultDataType>>, thisArg?: any): KoconutArray<DataType>;
    /**
     * Appends all elements yielded from results of ```transform``` function being invoked
     ...
     * ```
     */
    flatMapIndexedTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: IndexedTransformer<DataType, Iterable<ResultDataType>>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    groupByTo<KeyType, ValueType = DataType>(destination: Map<KeyType, Array<ValueType>>, keySelector: Selector<DataType, KeyType>, valueTransform?: Transformer<DataType, ValueType> | null, keySelectorThisArg?: any, valueTransformThisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    mapTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: Transformer<DataType, ResultDataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     * Applies the given ```transform``` function to each element of the original collection
     ...
     * ```
     */
    mapNotNullTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: Transformer<DataType, ResultDataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    mapIndexedTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: IndexedTransformer<DataType, ResultDataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     * Applies the given ```transform``` function to each element and its index in the original
     ...
     * ```
     */
    mapIndexedNotNullTo<ResultDataType>(destination: Array<ResultDataType> | Set<ResultDataType>, transform: IndexedTransformer<DataType, ResultDataType | void | null | undefined>, thisArg?: any): KoconutArray<DataType>;
    /**
    ...
    /**
       ...
       * ```
       */
    distinctBy<KeyType, EquatableKeyType extends KoconutEquatable>(selector: Selector<DataType, KeyType | EquatableKeyType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    dropLastWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    dropWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    filter(predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    filterNot(predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    filterTo(destination: Array<DataType> | Set<DataType>, predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    filterNotTo(destination: Array<DataType> | Set<DataType>, predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    filterIndexed(predicate: IndexedPredicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    filterIndexedTo(destination: Array<DataType> | Set<DataType>, predicate: IndexedPredicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    sortedBy(selector: Selector<DataType, number | string | KoconutComparable>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    sortedByDescending(selector: Selector<DataType, number | string | KoconutComparable>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    sortedWith(comparator: Comparator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    takeLastWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    takeWhile(predicate: Predicator<DataType>, thisArg?: any): KoconutArray<DataType>;

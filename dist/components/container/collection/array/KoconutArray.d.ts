import { Pair, KoconutPair, Entry, KoconutEntry, KoconutCollection, KoconutLoopSignal, KoconutEquatable, KoconutComparable } from "../../../../module";
export declare class KoconutArray<DataType> extends KoconutCollection<DataType, Array<DataType>> {
     ...
     * ```
     */
    static generate<DataType>(count: number, generator: (index: number) => DataType | Promise<DataType>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    onEach(action: (element: DataType) => boolean | KoconutLoopSignal | void | Promise<boolean | KoconutLoopSignal | void>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    onEachIndexed(action: (index: number, element: DataType) => boolean | KoconutLoopSignal | void | Promise<boolean | KoconutLoopSignal | void>, thisArg?: any): KoconutArray<DataType>;
    /**
     ...
     * ```
     */
    associateTo<KeyType, ValueType>(destination: Map<KeyType, ValueType>, transform: (element: DataType) => [
        KeyType,
        ValueType
    ] | Pair<KeyType, ValueType> | KoconutPair<KeyType, ValueType> | Entry<KeyType, ValueType> | KoconutEntry<KeyType, ValueType> | Promise<[
        KeyType,
        ValueType
    ] | Pair<KeyType, ValueType> | KoconutPair<KeyType, ValueType> | Entry<KeyType, ValueType> | KoconutEntry<KeyType, ValueType>>, thisArg?: any): KoconutArray<DataType>;
    /**

import { KoconutPrimitive, KoconutPair, Pair, Entry, KoconutIterable, KoconutArray, KoconutSet, KoconutMap, KoconutBoolean, Sequence, KoconutLoopSignal, KoconutEquatable, KoconutComparable } from "../../../module";
...
export declare class KoconutCollection<DataType, WrapperType extends Array<DataType> | Sequence<DataType> | Set<DataType>> extends KoconutIterable<DataType, DataType, WrapperType, WrapperType> {
     ...
     * ```
     */
    associate<KeyType, ValueType>(transform: (element: DataType) => [
        KeyType,
        ValueType
    ...
    associateTo<KeyType, ValueType>(destination: Map<KeyType, ValueType>, transform: (element: DataType) => [
        ...
        KeyType,
        ValueType
    ] | Pair<KeyType, ValueType> | KoconutPair<KeyType, ValueType> | Entry<KeyType, ValueType> | KoconutEntry<KeyType, ValueType>>, thisArg?: any): KoconutCollection<DataType, WrapperType>;
    /**

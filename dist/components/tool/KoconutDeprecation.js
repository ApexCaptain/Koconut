...
var deprecationWarningGenerators = {
  ...
  "japanese": function japanese(className, methodName, deprecationVersion, alternativeMethodName) {
    return "".concat(FontTextColour.Yellow, "[\u975E\u63A8\u5968\u306E\u8B66\u544A] ").concat(FontStyle.Reset, ": ") + "".concat(FontTextColour.Magenta, "'").concat(className, "'").concat(FontStyle.Reset, "\u30AF\u30E9\u30B9\u306E").concat(FontTextColour.Cyan, "'").concat(methodName, "'").concat(FontStyle.Reset, "\u30E1\u30BD\u30C3\u30C9\u306F") + "".concat(deprecationVersion ? "".concat(FontTextColour.Cyan, "'").concat(deprecationVersion, "'").concat(FontStyle.Reset, "\u30D0\u30FC\u30B8\u30E7\u30F3\u304B\u3089") : " \u5411\u5F8C", "\u30B5\u30DD\u30FC\u30C8\u304C").concat(FontTextColour.Yellow, "\u4E2D\u6B62").concat(FontStyle.Reset, "\u3055\u308C\u308B\u4E88\u5B9A\u3067\u3059\u3002") + "".concat(alternativeMethodName ? "\n                 \u305D\u306E\u6A5F\u80FD\u306F".concat(FontTextColour.Cyan, "'").concat(alternativeMethodName, "'").concat(FontStyle.Reset, "\u30E1\u30BD\u30C3\u30C9\u306B\u7F6E\u63DB\u3048\u3066\u4F7F\u7528\u3059\u308B\u3053\u3068\u3092\u304A\u52E7\u3081\u3057\u307E\u3059\u3002") : "");
  },
  "korean": function korean(className, methodName, deprecationVersion, alternativeMethodName) {
    return "".concat(FontTextColour.Yellow, "[\uC9C0\uC6D0 \uC911\uB2E8 \uACBD\uACE0] ").concat(FontStyle.Reset, ": ") + "".concat(FontTextColour.Magenta, "'").concat(className, "' ").concat(FontStyle.Reset, "\uD074\uB798\uC2A4\uC758 ").concat(FontTextColour.Cyan, "'").concat(methodName, "' ").concat(FontStyle.Reset, "\uBA54\uC18C\uB4DC\uB294") + "".concat(deprecationVersion ? " ".concat(FontTextColour.Cyan, "'").concat(deprecationVersion, "' ").concat(FontStyle.Reset, "\uBC84\uC804\uBD80\uD130") : " \uD5A5\uD6C4", " \uC9C0\uC6D0\uC774 ").concat(FontTextColour.Yellow, "\uC911\uB2E8").concat(FontStyle.Reset, " \uB420 \uC608\uC815\uC785\uB2C8\uB2E4.") + "".concat(alternativeMethodName ? "\n                   \uD574\uB2F9 \uAE30\uB2A5\uC740 ".concat(FontTextColour.Cyan, "'").concat(alternativeMethodName, "'").concat(FontStyle.Reset, " \uBA54\uC18C\uB4DC\uB85C \uB300\uCCB4\uD558\uC5EC \uC0AC\uC6A9\uD558\uB294 \uAC83\uC744 \uAD8C\uC7A5\uD569\uB2C8\uB2E4.") : "");
  }
};
      ...
      if (_module.KoconutOption.isDeprecationWarningEnabled) {
        ...
        if (this.isRunningOnDevUnitTesting) {
          try {
            ...
            if (!(0, _fs.existsSync)(this.devDepreactionListTmpDirPath)) (0, _fs.mkdirSync)(this.devDepreactionListTmpDirPath);
            if (!(0, _fs.existsSync)(this.devDepreactionListTmpFilePath)) (0, _fs.writeFileSync)(this.devDepreactionListTmpFilePath, "");
            if (!this.devDeprecationListSet) this.devDeprecationListSet = new Set((0, _fs.readFileSync)(this.devDepreactionListTmpFilePath, 'utf-8').split('\n'));

            if (!this.devDeprecationListSet.has(stringToAdd)) {
              this.devDeprecationListSet.add(stringToAdd);
              (0, _fs.appendFileSync)(this.devDepreactionListTmpFilePath, "\n".concat(stringToAdd));
            }
          } catch (error) {
            console.error(error);
          }
...
(0, _defineProperty2["default"])(KoconutDeprecation, "devDeprecationListSet", void 0);
(0, _defineProperty2["default"])(KoconutDeprecation, "devDepreactionListTmpDirPath", "./log");
(0, _defineProperty2["default"])(KoconutDeprecation, "devDepreactionListTmpFilePath", "".concat(KoconutDeprecation.devDepreactionListTmpDirPath, "/DevDeprecationList.tmp"));
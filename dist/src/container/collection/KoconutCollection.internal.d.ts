import { KoconutPrimitive, KoconutPair, Pair, Entry, KoconutIterable, KoconutArray, KoconutSet, KoconutMap, KoconutEquatable, KoconutComparable } from "../../../module.internal";
/** @internal */
export declare class KoconutCollection<DataType, WrapperType extends Array<DataType> | Set<DataType>> extends KoconutIterable<DataType, DataType, WrapperType, WrapperType> {
    validiate(data: WrapperType | null): Promise<void>;
    ...
    forEach(action: (element: DataType) => boolean | void | Promise<boolean | void>, thisArg?: any): KoconutPrimitive<void>;
    forEachIndexed(action: (index: number, element: DataType) => boolean | void | Promise<boolean | void>, thisArg?: any): KoconutPrimitive<void>;
    ...
    maxOf(selector: (element: DataType) => number | Promise<number>): KoconutPrimitive<number>;
    maxOf(selector: (element: DataType) => number | Promise<number>, thisArg: any): KoconutPrimitive<number>;
    maxOf(selector: (element: DataType) => string | Promise<string>): KoconutPrimitive<string>;
    maxOf(selector: (element: DataType) => string | Promise<string>, thisArg: any): KoconutPrimitive<string>;
    maxOf<ComparableType extends KoconutComparable>(selector: (element: DataType) => ComparableType | Promise<ComparableType>): KoconutPrimitive<ComparableType>;
    maxOf<ComparableType extends KoconutComparable>(selector: (element: DataType) => ComparableType | Promise<ComparableType>, thisArg: any): KoconutPrimitive<ComparableType>;
    ...
    maxOfOrNull<ComparableType extends KoconutComparable>(selector: (element: DataType) => ComparableType | Promise<ComparableType>): KoconutPrimitive<ComparableType | null>;
    maxOfOrNull<ComparableType extends KoconutComparable>(selector: (element: DataType) => ComparableType | Promise<ComparableType>, thisArg: any): KoconutPrimitive<ComparableType | null>;
    ...
    onEach(action: (element: DataType) => boolean | void | Promise<boolean | void>, thisArg?: any): KoconutCollection<DataType, WrapperType>;
    onEachIndexed(action: (index: number, element: DataType) => boolean | void | Promise<boolean | void>, thisArg?: any): KoconutCollection<DataType, WrapperType>;

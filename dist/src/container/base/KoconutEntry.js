...
class Entry {
     ...
     */
    constructor(keyElement, valueElement) {
     ...
     * @returns The Key of this key/value pair.
     */
    get key() { return this.keyElement; }
    /**
     * Returns the value of key/value pair.
     * @returns The value of this key/value pair.
     */
    get value() { return this.valueElement; }
    /**
     ...
     * ```
     */
    toString() { return JSON.stringify({ keyElement: this.key, valueElement: this.valueElement }); }
    /**
     ...
     * ```
     */
    toArray() { return this.toPair().toArray(); }
    /**
     ...
     * ```
     */
    toPair() { return new module_internal_1.Pair(this.key, this.value); }
    /**
     ...
     */
    equalsTo(other) {
        if (module_internal_1.KoconutTypeChecker.checkIsEquatable(this.key) && module_internal_1.KoconutTypeChecker.checkIsEquatable(other.key))
            return this.key.equalsTo(other.key);
        else
 ...
 *
 */
class KoconutEntry extends module_internal_1.KoconutPrimitive {
    /**

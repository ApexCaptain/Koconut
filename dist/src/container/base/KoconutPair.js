...
class Pair {
     ...
     * @returns The first value of this first/second pair.
     */
    get first() { return this.firstElement; }
    /**
     * Returns the second value of this first/second pair.
     * @returns The second value of this first/second pair.
     */
    get second() { return this.secondElement; }
    /**
     ...
     * ```
     */
    toString() { return JSON.stringify({ first: this.first, second: this.second }); }
    /**
     ...
     * ```
     */
    toEntry() { return new module_internal_1.Entry(this.first, this.second); }
    /**
    ...
    equalsTo(other) {
        ...
        if (module_internal_1.KoconutTypeChecker.checkIsEquatable(this.firstElement) && module_internal_1.KoconutTypeChecker.checkIsEquatable(other.firstElement))
            doseEquals = this.firstElement.equalsTo(other.firstElement);
        else
            doseEquals = this.firstElement == other.firstElement;
        if (doseEquals) {
            if (module_internal_1.KoconutTypeChecker.checkIsEquatable(this.secondElement) && module_internal_1.KoconutTypeChecker.checkIsEquatable(other.secondElement))
                doseEquals = this.secondElement.equalsTo(other.secondElement);
            else
                doseEquals = this.secondElement == other.secondElement;
        }
        return doseEquals;
    }
}
 ...
 */
class KoconutPair extends module_internal_1.KoconutPrimitive {
    /**

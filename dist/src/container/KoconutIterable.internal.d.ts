import { KoconutPrimitive, KoconutArray, KoconutLoopSignal, KoconutComparable } from "../../module.internal";
export declare class KoconutIterable<DataType, CombinedDataType, WrapperType extends Iterable<DataType>, CombinedWrapperType extends Iterable<CombinedDataType>> extends KoconutPrimitive<WrapperType> {
     ...
     * ```
     */
    forEachIndexed(action: (index: number, element: CombinedDataType) => boolean | KoconutLoopSignal | void | Promise<boolean | KoconutLoopSignal | void>, thisArg?: any): KoconutPrimitive<void>;
}

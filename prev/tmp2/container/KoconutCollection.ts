...
import {
KoconutOpener, KoconutPrimitive, KoconutPair, /*KoconutTypeChecker,*/ Pair, Entry,
KoconutArray, KoconutMap, KoconutSet,
KoconutInvalidArgumentException, KoconutIndexOutOfBoundsException,
                ...
                if(this.data != null) {
                    ...
                    for(let eachIndex in dataArray) {
                        ...
                        while(startIndex < endIndex) {
                            ...
                            if(
                                KoconutTypeChecker.checkIsComparable(currentComparable) && (targetComparable as any as KoconutComparable).compareTo(currentComparable) < 0

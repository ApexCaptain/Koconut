...
describe("".concat(_module.KoconutMap.name, " -- Transformer"), function () {
  ...
  it(_module.KoconutMap.prototype.mapVaues.name, (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee55() {
    var koconut, yieldable, result, expectedResultMap;

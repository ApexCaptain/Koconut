...
describe(
  ''.concat(_module.KoconutSet.name, ' -- Property Getter'),
  function () {
    it(
      _module.KoconutSet.prototype.size.name,
            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  (0, _chai.expect)(yieldable).to.be.instanceOf(
    ...
    it(
      _module.KoconutSet.prototype.indices.name,
      (0, _asyncToGenerator2['default'])(
...
describe(''.concat(_module.KoconutSet.name, ' -- Accumulator'), function () {
  it(
    _module.KoconutSet.prototype.fold.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.foldIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee4$(_context4) {
          while (1) {
            switch ((_context4.prev = _context4.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3, 4, 5]);
                yieldable = koconut.foldIndexed(
                  0,
                  function (eachIndex, acc, eachElement) {
...
describe(''.concat(_module.KoconutSet.name, ' -- Calculator'), function () {
  it(
    _module.KoconutSet.prototype.count.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              case 0:
                ...
                (0, _chai.expect)(yieldableCase1).to.be.instanceOf(
                  _module.KoconutPrimitive,
                );
                _context5.next = 5;
              ...
              case 5:
                ...
                (0, _chai.expect)(yieldableCase2).to.be.instanceOf(
                  _module.KoconutPrimitive,
                );
                _context5.next = 11;
  ...
  it(
    _module.KoconutSet.prototype.maxBy.name,
    (0, _asyncToGenerator2['default'])(
              ...
              switch ((_context6.prev = _context6.next)) {
                case 0:
                  koconut = _module.KoconutSet.from([
                    new _TestDataClasses.ProductInfo(
                      'A-1',
                      'Mac Book Pro -- May',
                      2000,
                    ),
                ...
                case 5:
                  ...
                  (0, _chai.expect)(resultCase1).eqls(
                    new _TestDataClasses.ProductInfo(
                      'A-3',
                      'iPhone -- June',
                      1500,
                ...
                case 11:
                  ...
                  (0, _chai.expect)(resultCase2).eqls(
                    new _TestDataClasses.ProductInfo(
                      'A-1',
                      'Mac Book Pro -- May',
                      2000,
                  ...
                  yieldableCase3 = koconut
                    .filter(function (eachElement) {
                ...
                case 19:
                  ...
                  (0, _chai.expect)(_context6.t0).to.be.instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.maxByOrNull.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context7.prev = _context7.next)) {
              ...
              case 11:
                ...
                (0, _chai.expect)(yieldableCase3).to.be.instanceOf(
                  _module.KoconutPrimitive,
                );
                _context7.next = 17;
  ...
  it(
    _module.KoconutSet.prototype.maxOf.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.maxOfOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.maxOfWith.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.maxOfWithOrNull.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context11.prev = _context11.next)) {
              case 0:
                ...
                yieldable = koconut.maxOfWithOrNull(
                  function (eachElement) {
                    return eachElement.name;
                  },
                  function (prev, rear) {
  ...
  it(
    _module.KoconutSet.prototype.maxWith.name,
    (0, _asyncToGenerator2['default'])(
            ...
            while (1) {
              switch ((_context12.prev = _context12.next)) {
                ...
                case 14:
                  ...
                  (0, _chai.expect)(_context12.t0).to.be.instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.maxWithOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.minBy.name,
    (0, _asyncToGenerator2['default'])(
            ...
            while (1) {
              switch ((_context14.prev = _context14.next)) {
                ...
                case 19:
                  ...
                  (0, _chai.expect)(_context14.t0).to.be.instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.minByOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.minOf.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context16.prev = _context16.next)) {
              ...
              case 5:
                ...
                (0, _chai.expect)(resultCase1).equals(
                  'Mac Book Air -- September',
                );
  ...
  it(
    _module.KoconutSet.prototype.minOfOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.minOfWith.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.minOfWithOrNull.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context19.prev = _context19.next)) {
              case 0:
                ...
                yieldable = koconut.minOfWithOrNull(
                  function (eachElement) {
                    return eachElement.name;
                  },
                  function (prev, rear) {
  ...
  it(
    _module.KoconutSet.prototype.minWith.name,
    (0, _asyncToGenerator2['default'])(
            ...
            while (1) {
              switch ((_context20.prev = _context20.next)) {
                ...
                case 14:
                  ...
                  (0, _chai.expect)(_context20.t0).to.be.instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.minWithOrNull.name,
    (0, _asyncToGenerator2['default'])(
...
describe(''.concat(_module.KoconutSet.name, ' -- Caster'), function () {
  it(
    _module.KoconutSet.prototype.asArray.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.asSet.name,
    (0, _asyncToGenerator2['default'])(
...
describe(''.concat(_module.KoconutSet.name, ' -- Inspector'), function () {
  it(
    _module.KoconutSet.prototype.all.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.any.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.isEmpty.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.isNotEmpty.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.isNullOrEmpty.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.contains.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context29.prev = _context29.next)) {
              ...
              case 11:
                ...
                (0, _chai.expect)(resultCase2).to.equals(false);
                koconutCase3 = _module.KoconutArray.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                ]);
                yieldableCase3 = koconutCase3.contains(
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                );
                (0, _chai.expect)(yieldableCase3).to.be.instanceOf(
                  _module.KoconutBoolean,
  ...
  it(
    _module.KoconutSet.prototype.containsAll.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context30.prev = _context30.next)) {
              ...
              case 11:
                ...
                (0, _chai.expect)(resultCase2).to.equals(false);
                koconutCase3 = _module.KoconutSet.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                ]);
                yieldableCase3 = koconutCase3.containsAll([
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                ]);
                (0, _chai.expect)(yieldableCase3).to.be.instanceOf(
              ...
              case 18:
                ...
                koconutCase4 = _module.KoconutSet.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                ]);
                yieldableCase4 = koconutCase4.containsAll([
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Steve', 'Jobs'),
                ]);
                (0, _chai.expect)(yieldableCase4).to.be.instanceOf(
                  _module.KoconutBoolean,
                );
                _context30.next = 25;
  ...
  it(
    _module.KoconutSet.prototype.none.name,
    (0, _asyncToGenerator2['default'])(
...
describe(''.concat(_module.KoconutSet.name, ' -- Iterator'), function () {
  it(
    _module.KoconutSet.prototype.forEach.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.forEachIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee33$(_context33) {
          while (1) {
            switch ((_context33.prev = _context33.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3, 4, 5]);
                yieldable = koconut.forEachIndexed(function (
                  eachIndex,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.onEach.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.onEachIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee35$(_context35) {
          while (1) {
            switch ((_context35.prev = _context35.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3, 4, 5]);
                yieldable = koconut.onEachIndexed(function (
                  eachIndex,
                  eachElement,
                ) {
                  (0, _chai.expect)(eachElement - eachIndex).equals(1);
...
describe(''.concat(_module.KoconutSet.name, ' -- Manipulator'), function () {
  it(
    _module.KoconutSet.prototype.distinct.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context36.prev = _context36.next)) {
              ...
              case 5:
                ...
                (0, _chai.expect)(Array.from(resultCase1).join('')).equals(
                  'aAbBcC',
                );
                koconutCase2 = _module.KoconutSet.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
              ...
              case 12:
                ...
                expectedResultArrayCase2 = [
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                ];
                (0, _chai.expect)(Array.from(resultCase2)).to.eql(
                  expectedResultArrayCase2,
                );
  ...
  it(
    _module.KoconutSet.prototype.distinctBy.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context37.prev = _context37.next)) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.distinctBy(function (
                  eachElement,
                ) {
                  return eachElement;
                });
  ...
  it(
    _module.KoconutSet.prototype.drop.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.dropLast.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.dropLastWhile.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.dropWhile.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.filter.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.filterNot.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.filterTo.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.filterNotTo.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.filterIndexed.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context46.prev = _context46.next)) {
              case 0:
                ...
                yieldable = koconut.filterIndexed(function (
                  eachIndex,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.filterIndexedTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context47.prev = _context47.next)) {
              case 0:
                koconut = _module.KoconutSet.from([0, 1, 2, 3, 4, 8, 6]);
                destination = new Set();
                yieldable = koconut.filterIndexedTo(
                  destination,
              ...
              case 6:
                (0, _chai.expect)(destination).eqls(
                  new Set([0, 1, 2, 3, 4, 6]),
                );
  ...
  it(
    _module.KoconutSet.prototype.filterNotNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.filterNotNullTo.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.sortedBy.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context50.prev = _context50.next)) {
              ...
              case 19:
                ...
                (0, _chai.expect)(resultCase3).eqls(
                  new Set(expectedResultArrayCase3),
                );
  ...
  it(
    _module.KoconutSet.prototype.sortedByDescending.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee51$(_context51) {
          while (1) {
            switch ((_context51.prev = _context51.next)) {
              case 0:
                koconutCase1 = _module.KoconutSet.from(['aaa', 'cc', 'bbbb']);
                yieldableCase1 = koconutCase1.sortedByDescending(function (
                  eachElement,
                ) {
                  return eachElement.length;
                });
              ...
              case 5:
                ...
                koconutCase2 = _module.KoconutSet.from('dcba');
                yieldableCase2 = koconutCase2.sortedByDescending(function (
                  eachElement,
                ) {
                  return eachElement;
                });
              ...
              case 12:
                ...
                yieldableCase3 = koconutCase3.sortedByDescending(function (
                  eachElement,
                ) {
                  return eachElement;
                });
  ...
  it(
    _module.KoconutSet.prototype.sortedWith.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee52$(_context52) {
          while (1) {
            switch ((_context52.prev = _context52.next)) {
              case 0:
                koconutCase1 = _module.KoconutSet.from(['aaa', 'cc', 'bbbb']);
                yieldableCase1 = koconutCase1.sortedWith(function (
                  front,
                  rear,
                ) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.sortedWith(function (
                  front,
                  rear,
                ) {
                  return front.name.length - rear.name.length;
              ...
              case 12:
                ...
                (0, _chai.expect)(resultCase2).eqls(
                  new Set(expectedResultArrayCase2),
                );
  ...
  it(
    _module.KoconutSet.prototype.take.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.takeLast.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.takeLastWhile.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.takeWhile.name,
    (0, _asyncToGenerator2['default'])(
...
describe(''.concat(_module.KoconutSet.name, ' -- Selector'), function () {
  it(
    _module.KoconutSet.prototype.elementAt.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.elementAtOrElse.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.elementAtOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.find.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.findLast.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.first.name,
    (0, _asyncToGenerator2['default'])(
            ...
            while (1) {
              switch ((_context62.prev = _context62.next)) {
                ...
                case 8:
                  ...
                  (0, _chai.expect)(_context62.t0).instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
                ...
                case 19:
                  ...
                  (0, _chai.expect)(_context62.t1).instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.firstOrNull.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context63.prev = _context63.next)) {
              ...
              case 5:
                ...
                koconutCase2 = _module.KoconutSet.from('abc');
                yieldableCase2 = koconutCase2.firstOrNull(function (
                  eachElement,
                ) {
                  return eachElement > 'd';
                });
...
describe(''.concat(_module.KoconutSet.name, ' -- Transformer'), function () {
  it(
    _module.KoconutSet.prototype.associate.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee64() {
        var koconut;
        var expectedResultEntryArray;
        var yieldableCase1;
        var resultCase1;
        var yieldableCase2;
        var resultCase2;
            ...
            switch ((_context64.prev = _context64.next)) {
              case 0:
                ...
                yieldableCase1 = koconut.associate(function (eachElement) {
                  ...
                  var _eachElement$split2 = (0, _slicedToArray2['default'])(
                    _eachElement$split,
                    2,
                  );
                  var firstName = _eachElement$split2[0];
                  var lastName = _eachElement$split2[1];
              ...
              case 6:
                ...
                (0, _chai.expect)(Array.from(resultCase1.entries())).to.eql(
                  expectedResultEntryArray,
                );
                yieldableCase2 = koconut.associate(function (eachElement) {
                  var _eachElement$split3 = eachElement.split(' ');
                  var _eachElement$split4 = (0, _slicedToArray2['default'])(
                    _eachElement$split3,
                    2,
                  );
                  var firstName = _eachElement$split4[0];
                  var lastName = _eachElement$split4[1];
              ...
              case 12:
                ...
                (0, _chai.expect)(Array.from(resultCase2.entries())).to.eql(
                  expectedResultEntryArray,
                );
                yieldableCase3 = koconut.associate(function (eachElement) {
                  var _eachElement$split5 = eachElement.split(' ');
                  var _eachElement$split6 = (0, _slicedToArray2['default'])(
                    _eachElement$split5,
                    2,
                  );
                  var firstName = _eachElement$split6[0];
                  var lastName = _eachElement$split6[1];
              ...
              case 18:
                ...
                (0, _chai.expect)(Array.from(resultCase3.entries())).to.eql(
                  expectedResultEntryArray,
                );
  ...
  it(
    _module.KoconutSet.prototype.associateBy.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee65() {
        ...
        var yieldableCase2;
        var resultCase2;
        var expectedResultEntryArrayCase2;
          ...
          while (1) {
            switch ((_context65.prev = _context65.next)) {
              ...
              case 5:
                ...
                (0, _chai.expect)(
                  resultCase1 === null || resultCase1 === void 0
                    ? void 0
                    : resultCase1.get('Hopper'),
                ).to.eql(new _TestDataClasses.Person('Grace', 'Hopper'));
                (0, _chai.expect)(
                  resultCase1 === null || resultCase1 === void 0
                    ? void 0
                    : resultCase1.get('Bernoulli'),
                ).to.eql(new _TestDataClasses.Person('Jacob', 'Bernoulli'));
                (0, _chai.expect)(
                  resultCase1 === null || resultCase1 === void 0
                    ? void 0
                    : resultCase1.get('Luvya'),
                ).to.eql(new _TestDataClasses.Person('Jinyoung', 'Luvya'));
                yieldableCase2 = koconut.associateBy(
                  function (eachElement) {
                    return eachElement.lastName;
                  },
                  function (eachElement) {
  ...
  it(
    _module.KoconutSet.prototype.associateByTo.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee66() {
        var koconut;
        var destinationCase1;
        var yieldableCase1;
        var destinationCase2;
        var yieldableCase2;
        var expectedResultEntryArrayCase2;
          ...
          while (1) {
            switch ((_context66.prev = _context66.next)) {
              case 0:
                ...
                yieldableCase1 = koconut.associateByTo(
                  destinationCase1,
                  function (eachElement) {
                    return eachElement.lastName;
                  },
              ...
              case 6:
                (0, _chai.expect)(destinationCase1.get('Hopper')).to.eql(
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                );
                (0, _chai.expect)(destinationCase1.get('Bernoulli')).to.eql(
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                );
                (0, _chai.expect)(destinationCase1.get('Luvya')).to.eql(
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                );
                destinationCase2 = new Map();
                yieldableCase2 = koconut.associateByTo(
                  destinationCase2,
                  function (eachElement) {
                    return eachElement.lastName;
                  },
              ...
              case 14:
                ...
                (0, _chai.expect)(
                  Array.from(destinationCase2.entries()),
                ).to.eql(expectedResultEntryArrayCase2);
  ...
  it(
    _module.KoconutSet.prototype.associateTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context67.prev = _context67.next)) {
              case 0:
                ...
                destinationCase1 = new Map();
                yieldableCase1 = koconut.associateTo(
                  destinationCase1,
                  function (eachElement) {
                    var _eachElement$split7 = eachElement.split(' ');
                    var _eachElement$split8 = (0, _slicedToArray2['default'])(
                      _eachElement$split7,
                      2,
                    );
                    var firstName = _eachElement$split8[0];
                    var lastName = _eachElement$split8[1];
              ...
              case 7:
                (0, _chai.expect)(
                  Array.from(destinationCase1.entries()),
                ).to.eql(expectedResultEntryArray);
                destinationCase2 = new Map();
                yieldableCase2 = koconut.associateTo(
                  destinationCase2,
                  function (eachElement) {
                    var _eachElement$split9 = eachElement.split(' ');
                    var _eachElement$split10 = (0, _slicedToArray2['default'])(
                      _eachElement$split9,
                      2,
                    );
                    var firstName = _eachElement$split10[0];
                    var lastName = _eachElement$split10[1];
              ...
              case 13:
                ...
                yieldableCase3 = koconut.associateTo(
                  destinationCase3,
                  function (eachElement) {
                    var _eachElement$split11 = eachElement.split(' ');
                    var _eachElement$split12 = (0, _slicedToArray2['default'])(
                      _eachElement$split11,
                      2,
                    );
                    var firstName = _eachElement$split12[0];
                    var lastName = _eachElement$split12[1];
              ...
              case 19:
                (0, _chai.expect)(
                  Array.from(destinationCase3.entries()),
                ).to.eql(expectedResultEntryArray);
  ...
  it(
    _module.KoconutSet.prototype.associateWith.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context68.prev = _context68.next)) {
              ...
              case 5:
                ...
                (0, _chai.expect)(Array.from(result.entries())).to.eql(
                  expectedResultEntryArray,
                );
  ...
  it(
    _module.KoconutSet.prototype.associateWithTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context69.prev = _context69.next)) {
              case 0:
                ...
                destination = new Map();
                yieldable = koconut.associateWithTo(
                  destination,
                  function (eachElement) {
                    return eachElement.length;
                  },
              ...
              case 6:
                ...
                (0, _chai.expect)(Array.from(destination.entries())).to.eql(
                  expectedResultEntryArray,
                );
  ...
  it(
    _module.KoconutSet.prototype.chunked.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee70() {
        var koconut;
        var yieldableCase1;
        var resultCase1;
        var expectedResultArrayCase1;
        var yieldableCase2;
        var resultCase2;
        var expectedResultArrayCase2;
  ...
  it(
    _module.KoconutSet.prototype.flatMap.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.flatMapIndexed.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context72.prev = _context72.next)) {
              case 0:
                ...
                yieldable = koconut.flatMapIndexed(function (
                  eachIndex,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.flatMapTo.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.flatMapIndexedTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context74.prev = _context74.next)) {
              case 0:
                koconut = _module.KoconutSet.from(['abc', 'def', 'ghi', 'jkl']);
                destination = new Array();
                yieldable = koconut.flatMapIndexedTo(
                  destination,
                  function (eachIndex, eachElement) {
                    if (eachIndex % 2 == 0) return eachElement.split('');
                    else return [];
  ...
  it(
    _module.KoconutSet.prototype.groupBy.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee75() {
        var koconutCase1;
        var yieldableCase1;
        var resultCase1;
        var expectedResultEntryArrayCase1;
        var koconutCase2;
        var yieldableCase2;
        var resultCase2;
        var expectedResultEntryArrayCase2;
        return _regenerator['default'].wrap(function _callee75$(_context75) {
          while (1) {
            switch ((_context75.prev = _context75.next)) {
              case 0:
                koconutCase1 = _module.KoconutSet.from([
                  'a',
                  'abc',
                  'ab',
                  'def',
              ...
              case 5:
                ...
                (0, _chai.expect)(Array.from(resultCase1.entries())).eqls(
                  expectedResultEntryArrayCase1,
                );
                koconutCase2 = _module.KoconutSet.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                ...
                yieldableCase2 = koconutCase2.groupBy(
                  function (eachElement) {
                    return eachElement.lastName;
                  },
                  function (eachElement) {
              ...
              case 13:
                ...
                (0, _chai.expect)(Array.from(resultCase2.entries())).eqls(
                  expectedResultEntryArrayCase2,
                );
  ...
  it(
    _module.KoconutSet.prototype.groupByTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context76.prev = _context76.next)) {
              case 0:
                ...
                destinationCase1 = new Map();
                yieldableCase1 = koconutCase1.groupByTo(
                  destinationCase1,
                  function (eachElement) {
                    return eachElement.length;
                  },
              ...
              case 6:
                ...
                (0, _chai.expect)(Array.from(destinationCase1.entries())).eqls(
                  expectedResultEntryArrayCase1,
                );
                koconutCase2 = _module.KoconutSet.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                ...
                destinationCase2 = new Map();
                yieldableCase2 = koconutCase2.groupByTo(
                  destinationCase2,
                  function (eachElement) {
                    return eachElement.lastName;
                  },
              ...
              case 14:
                ...
                (0, _chai.expect)(Array.from(destinationCase2.entries())).eqls(
                  expectedResultEntryArrayCase2,
                );
  ...
  it(
    _module.KoconutSet.prototype.map.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.mapIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee78$(_context78) {
          while (1) {
            switch ((_context78.prev = _context78.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3]);
                yieldable = koconut.mapIndexed(function (
                  eachIndex,
                  eachElement,
                ) {
                  return eachIndex + eachElement;
  ...
  it(
    _module.KoconutSet.prototype.mapIndexedNotNull.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee79$(_context79) {
          while (1) {
            switch ((_context79.prev = _context79.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3, 4, 5]);
                yieldable = koconut.mapIndexedNotNull(function (
                  eachIndex,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.mapIndexedNotNullTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context80.prev = _context80.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3, 4, 5]);
                destination = new Set();
                yieldable = koconut.mapIndexedNotNullTo(
                  destination,
                  function (eachIndex, eachElement) {
                    if (eachIndex % 2 == 0) return eachElement * eachElement;
                  },
  ...
  it(
    _module.KoconutSet.prototype.mapIndexedTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context81.prev = _context81.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3]);
                destination = new Set();
                yieldable = koconut.mapIndexedTo(
                  destination,
                  function (eachIndex, eachElement) {
                    return eachIndex + eachElement;
                  },
  ...
  it(
    _module.KoconutSet.prototype.mapNotNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.mapNotNullTo.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context83.prev = _context83.next)) {
              case 0:
                koconut = _module.KoconutSet.from([1, 2, 3, 4, 5]);
                destination = new Set();
                yieldable = koconut.mapNotNullTo(
                  destination,
                  function (eachElement) {
                    if (eachElement % 2 == 0) return eachElement * eachElement;
                  },
  ...
  it(
    _module.KoconutSet.prototype.mapTo.name,
    (0, _asyncToGenerator2['default'])(
...
describe(''.concat(_module.KoconutSet.name, ' -- Function'), function () {
  it(
    _module.KoconutSet.prototype.indexOf.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context85.prev = _context85.next)) {
              ...
              case 12:
                ...
                yieldableCase3 = koconutCase3.indexOf(
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                );
                (0, _chai.expect)(yieldableCase3).to.be.instanceOf(
                  _module.KoconutPrimitive,
  ...
  it(
    _module.KoconutSet.prototype.indexOfFirst.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.indexOfLast.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.intersect.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context88.prev = _context88.next)) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.intersect([
                  new _TestDataClasses.ProductInfo(
                    'A-1',
                    'Mac Book Pro -- April',
                    2000,
              ...
              case 12:
                ...
                (0, _chai.expect)(Array.from(resultCase2)).eqls([
                  new _TestDataClasses.ProductInfo(
                    'A-1',
                    'Mac Book Pro -- May',
                    2000,
  ...
  it(
    _module.KoconutSet.prototype.join.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context91.prev = _context91.next)) {
              ...
              case 17:
                ...
                (0, _chai.expect)(resultCase3).equals(
                  '< A - B - C - D - E ~ >',
                );
  ...
  it(
    _module.KoconutSet.prototype.last.name,
    (0, _asyncToGenerator2['default'])(
              ...
              switch ((_context92.prev = _context92.next)) {
                case 0:
                  ...
                  yieldableCase1 = koconutCase1
                    ...
                    .last();
                  (0, _chai.expect)(koconutCase1).to.be.instanceOf(
                    _module.KoconutPrimitive,
                  );
                  _context92.prev = 3;
                  _context92.next = 6;
                ...
                case 8:
                  ...
                  (0, _chai.expect)(_context92.t0).instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
                ...
                case 19:
                  ...
                  (0, _chai.expect)(_context92.t1).instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.lastIndexOf.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context93.prev = _context93.next)) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.lastIndexOf(
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                );
                (0, _chai.expect)(yieldableCase2).to.be.instanceOf(
                  _module.KoconutPrimitive,
  ...
  it(
    _module.KoconutSet.prototype.lastOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.minus.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context95.prev = _context95.next)) {
              ...
              case 12:
                ...
                yieldableCase3 = koconutCase3.minus(
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                );
                (0, _chai.expect)(yieldableCase3).to.be.instanceOf(
                  _module.KoconutSet,
              ...
              case 19:
                ...
                (0, _chai.expect)(resultCase3).eql(
                  new Set(expectedResultArrayCase3),
                );
                koconutCase4 = _module.KoconutSet.from([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                ...
                yieldableCase4 = koconutCase4.minus([
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                  new _TestDataClasses.Person('Johann', 'Bernoulli'),
                ]);
                (0, _chai.expect)(yieldableCase4).to.be.instanceOf(
              ...
              case 27:
                ...
                expectedResultArrayCase4 = [
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jinyoung', 'Luvya'),
                ];
                (0, _chai.expect)(resultCase4).eql(
                  new Set(expectedResultArrayCase4),
                );
  ...
  it(
    _module.KoconutSet.prototype.minusElement.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context96.prev = _context96.next)) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.minusElement(
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                );
                (0, _chai.expect)(yieldableCase2).to.be.instanceOf(
                  _module.KoconutSet,
              ...
              case 12:
                ...
                (0, _chai.expect)(resultCase2).eql(
                  new Set(expectedResultArrayCase2),
                );
  ...
  it(
    _module.KoconutSet.prototype.partition.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context97.prev = _context97.next)) {
              ...
              case 5:
                ...
                (0, _chai.expect)(result).eqls(
                  new _module.Pair(new Set([2, 4]), new Set([1, 3, 5])),
                );
  ...
  it(
    _module.KoconutSet.prototype.plus.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.plusElement.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.random.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.randomOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.reduce.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.reduceIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee103$(_context103) {
          while (1) {
            switch ((_context103.prev = _context103.next)) {
              case 0:
                koconut = _module.KoconutSet.from('abcd');
                yieldable = koconut.reduceIndexed(function (
                  eachIndex,
                  acc,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.reduceIndexedOrNull.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee104$(_context104) {
          while (1) {
            switch ((_context104.prev = _context104.next)) {
              case 0:
                koconut = _module.KoconutSet.from('abcd');
                yieldableCase1 = koconut.reduceIndexedOrNull(function (
                  eachIndex,
                  acc,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.reduceOrNull.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee105$(_context105) {
          while (1) {
            switch ((_context105.prev = _context105.next)) {
              case 0:
                koconut = _module.KoconutSet.from('abcd');
                yieldableCase1 = koconut.reduceOrNull(function (
                  acc,
                  eachElement,
                ) {
                  return acc + eachElement;
  ...
  it(
    _module.KoconutSet.prototype.reversed.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.runningFold.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee107$(_context107) {
          while (1) {
            switch ((_context107.prev = _context107.next)) {
              case 0:
                koconut = _module.KoconutSet.from('abcd');
                yieldable = koconut.runningFold(
                  'W',
                  function (acc, eachElement) {
                    return acc + eachElement;
                  },
                );
                (0, _chai.expect)(yieldable).to.be.instanceOf(
  ...
  it(
    _module.KoconutSet.prototype.runningFoldIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee108$(_context108) {
          while (1) {
            switch ((_context108.prev = _context108.next)) {
              case 0:
                koconut = _module.KoconutSet.from('abcd');
                yieldable = koconut.runningFoldIndexed(
                  'W',
                  function (eachIndex, acc, eachElement) {
                    return acc + eachElement + eachIndex;
                  },
  ...
  it(
    _module.KoconutSet.prototype.runningReduce.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.runningReduceIndexed.name,
    (0, _asyncToGenerator2['default'])(
        ...
        return _regenerator['default'].wrap(function _callee110$(_context110) {
          while (1) {
            switch ((_context110.prev = _context110.next)) {
              case 0:
                koconut = _module.KoconutSet.from('abcd');
                yieldable = koconut.runningReduceIndexed(function (
                  eachIndex,
                  acc,
                  eachElement,
                ) {
  ...
  it(
    _module.KoconutSet.prototype.scan.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.scanIndexed.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.shuffled.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee113() {
        ...
        var _iterator;
        var _step;
        var eachShuffledElement;

        return _regenerator['default'].wrap(
          function _callee113$(_context113) {
            while (1) {
  ...
  it(
    _module.KoconutSet.prototype.single.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee114() {
        ...
        var yieldableCase5;
        return _regenerator['default'].wrap(
          function _callee114$(_context114) {
            while (1) {
              switch ((_context114.prev = _context114.next)) {
                ...
                case 14:
                  ...
                  (0, _chai.expect)(_context114.t0).instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
                ...
                case 30:
                  ...
                  (0, _chai.expect)(_context114.t1).to.be.instanceOf(
                    _module.KoconutConflictException,
                  );
                ...
                case 33:
                  ...
                  (0, _chai.expect)(yieldableCase5).to.be.instanceOf(
                    _module.KoconutPrimitive,
                  );
                  _context114.prev = 35;
                  _context114.next = 38;
                ...
                case 40:
                  ...
                  (0, _chai.expect)(_context114.t2).to.be.instanceOf(
                    _module.KoconutNoSuchElementException,
                  );
  ...
  it(
    _module.KoconutSet.prototype.singleOrNull.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.subtract.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context116.prev = _context116.next)) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.subtract([
                  new _TestDataClasses.Person('Grace', 'Hopper'),
                  new _TestDataClasses.Person('Jacob', 'Bernoulli'),
                ]);
                (0, _chai.expect)(yieldableCase2).to.be.instanceOf(
              ...
              case 12:
                ...
                (0, _chai.expect)(resultCase2).eqls(
                  new Set([new _TestDataClasses.Person('Jinyoung', 'Luvya')]),
                );
  ...
  it(
    _module.KoconutSet.prototype.sumBy.name,
    (0, _asyncToGenerator2['default'])(
  ...
  it(
    _module.KoconutSet.prototype.union.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context118.prev = _context118.next)) {
              ...
              case 5:
                ...
                yieldableCase2 = koconutCase2.union([
                  new _TestDataClasses.Person('Steve', 'Jobs'),
                  new _TestDataClasses.Person('SangHun', 'Luvya'),
                ]);
                (0, _chai.expect)(yieldableCase2).to.be.instanceOf(
                  _module.KoconutSet,
                );
  ...
  it(
    _module.KoconutSet.prototype.windowed.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context119.prev = _context119.next)) {
              ...
              case 17:
                ...
                yieldableCase4 = koconut.windowed(
                  3,
                  2,
                  false,
  ...
  it(
    _module.KoconutSet.prototype.withIndex.name,
    (0, _asyncToGenerator2['default'])(
          ...
          while (1) {
            switch ((_context120.prev = _context120.next)) {
              ...
              case 5:
                ...
                expectedResultEntryArray = [
                  new _module.Entry(0, 'a'),
                  new _module.Entry(1, 'b'),
                  new _module.Entry(2, 'c'),
                  new _module.Entry(3, 'd'),
                  new _module.Entry(4, 'e'),
                ];
  ...
  it(
    _module.KoconutSet.prototype.zip.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee121() {
        var koconut;
        var yieldableCase1;
        var resultCase1;
        var expectedResultPairArrayCase1;
        var yieldableCase2;
        var resultCase2;
          ...
          while (1) {
            switch ((_context121.prev = _context121.next)) {
              ...
              case 5:
                ...
                expectedResultPairArrayCase1 = [
                  new _module.Pair(1, 'a'),
                  new _module.Pair(2, 'b'),
                  new _module.Pair(3, 'c'),
                  new _module.Pair(4, 'd'),
                  new _module.Pair(5, 'e'),
                ];
                (0, _chai.expect)(resultCase1).eqls(
                  expectedResultPairArrayCase1,
                );
                yieldableCase2 = koconut.zip(
                  'abc',
                  function (eachElement, eachOtherElement) {
  ...
  it(
    _module.KoconutSet.prototype.zipWithNext.name,
    (0, _asyncToGenerator2['default'])(
      _regenerator['default'].mark(function _callee122() {
        var koconut;
        var yieldableCase1;
        var resultCase1;
        var expectedResultPairArrayCase1;
          ...
          while (1) {
            switch ((_context122.prev = _context122.next)) {
              ...
              case 5:
                ...
                expectedResultPairArrayCase1 = [
                  new _module.Pair(1, 2),
                  new _module.Pair(2, 3),
                  new _module.Pair(3, 4),
                  new _module.Pair(4, 5),
                ];
                (0, _chai.expect)(resultCase1).eqls(
                  expectedResultPairArrayCase1,
                );
                yieldableCase2 = koconut.zipWithNext(function (
                  eachFirstElement,
                  eachSecondElement,
                ) {
